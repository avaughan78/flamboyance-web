...
import { Shell, Wordmark, LeaveButton, CountdownRing, Avatar, RankBadge, inputStyle } from './components/Shared'
...
export default function App() {
  ...
  if (!room) {
    ...
    if (mode === 'party') {
      return <JoinScreen onJoin={handleJoin} onBack={codeFromUrl() ? undefined : () => setMode('landing')} />
    }
...
function JoinScreen({ onJoin, onBack }: { onJoin: (code: string, name: string) => Promise<void>; onBack?: () => void }) {
